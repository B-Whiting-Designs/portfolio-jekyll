...
<form class="pl-3 pr-3" method="post" action="<?php echo e(route('users.invite.update',[$currantWorkspace->slug])); ?>">
    <?php echo csrf_field(); ?>
...
<script>
    var UserNames = new Bloodhound({
        ...
        prefetch: {
            url: '<?php echo e(route('user.email.json',$currantWorkspace->id)); ?>',
            cache:false,
...
</script><?php /**PATH /home/bwhitwbh/public_html/projects/resources/views/users/invite.blade.php ENDPATH**/ ?>