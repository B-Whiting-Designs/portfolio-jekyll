  ...
  <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
    ...
    <div class="dropdown-menu dropdown-menu-right">
      <?php $__currentLoopData = Auth::user()->workspace; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workspace): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <?php if(isset($workspace->pivot->permission)): ?>
            <?php if($workspace->pivot->permission =='Owner'): ?>
              <a href="#" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Rename Workspace')); ?>" data-url="<?php echo e(route('rename_workspace',$workspace->id)); ?>" class="edit-workspace"><i class="mdi mdi-pencil"></i></a>
            <?php endif; ?>
          <?php endif; ?>
      ...
      <?php endif; ?>
        ...
        <div class="dropdown-divider"></div>
          <?php endif; ?>
          <a href="<?php if(auth()->guard('web')->check()): ?><?php echo e(route('users.my.account')); ?><?php elseif(auth()->guard()->check()): ?><?php echo e(route('client.users.my.account')); ?><?php endif; ?>" class="dropdown-item has-icon">
...
<?php /**PATH /home/bwhitwbh/public_html/projects/resources/views/partials/topnav.blade.php ENDPATH**/ ?>