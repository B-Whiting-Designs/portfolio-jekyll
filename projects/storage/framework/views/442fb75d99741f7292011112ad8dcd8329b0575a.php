...
<?php $__env->startSection('container'); ?>
    ...
    <?php if($message = \Session::get('my_error')): ?>
        ...
        <form method="post" action="<?php echo e(route('LaravelInstaller::environmentSaveWizard')); ?>" class="tabs-wrap">
            <div class="" id="tab1content">
                ...
                <div class="form-group <?php echo e($errors->has('app_name') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="text" name="app_name" id="app_name" value="<?php echo e(old('app_name')); ?>" placeholder="<?php echo e(trans('installer_messages.environment.wizard.form.app_name_placeholder')); ?>" />
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/taskly-saas-test/taskly/resources/views/vendor/installer/environment-wizard.blade.php ENDPATH**/ ?>