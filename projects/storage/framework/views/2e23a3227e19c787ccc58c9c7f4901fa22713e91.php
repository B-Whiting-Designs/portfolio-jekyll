...
<?php if($message = Session::get('success')): ?>
    <script>toastr('Success','<?php echo $message; ?>','success')</script>
<?php endif; ?>

<?php if($message = Session::get('error')): ?>
    <script>toastr('Error','<?php echo $message; ?>','error')</script>
<?php endif; ?>

<?php if($message = Session::get('info')): ?>
    <script>toastr('Info','<?php echo $message; ?>','info')</script>
<?php endif; ?>
<?php if($message = Session::get('warning')): ?>
    <script>toastr('Warning', '<?php echo $message; ?>', 'warning')</script>
<?php endif; ?>
</body>

</html>
<?php /**PATH /home/bwhitwbh/public_html/projects/resources/views/layouts/main.blade.php ENDPATH**/ ?>