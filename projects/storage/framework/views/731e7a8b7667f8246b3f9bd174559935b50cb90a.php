...
<?php if($project && $currantWorkspace): ?>
    ...
    <form class="pl-3 pr-3" method="post" action="<?php if(auth()->guard('web')->check()): ?><?php echo e(route('projects.milestone.store',[$currantWorkspace->slug,$project->id])); ?><?php elseif(auth()->guard()->check()): ?><?php echo e(route('client.projects.milestone.store',[$currantWorkspace->slug,$project->id])); ?><?php endif; ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control form-control-light" id="milestone-title" placeholder="<?php echo e(__('Enter Cost')); ?>" value="0" min="0" name="cost" required>
        </div>
        <div class="form-group">
...
<?php endif; ?>
<?php /**PATH /home/bwhitwbh/public_html/projects/resources/views/projects/milestone.blade.php ENDPATH**/ ?>