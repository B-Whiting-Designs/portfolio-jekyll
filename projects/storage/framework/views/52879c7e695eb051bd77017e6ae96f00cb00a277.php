    ...
    <div class="p-2">
        ...
        <div class="tab-content">
                            ...
                            <li class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="float-right">
                                        <a href="#" class="text-danger text-muted delete-comment" data-url="<?php echo e(route('comment.destroy',[$currantWorkspace->slug,$task->project_id,$task->id,$comment->id])); ?>">
                        ...
                        <div class="card-body pt-2 pb-2">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    ...
                                    <?php if(empty($clientID)): ?>
                                        <a href="#" class="text-danger text-muted delete-comment-file" data-url="<?php echo e(route('comment.destroy.file',[$currantWorkspace->slug,$task->project_id,$task->id,$file->id])); ?>">
                                            <i class="dripicons-trash"></i>
                                        </a>
                                    <?php endif; ?>
                                </div>
            ...
            <div class="tab-pane show" id="sub-task">
                ...
                <form method="post" id="form-subtask" class="collapse" data-action="<?php echo e(route('subtask.store',[$currantWorkspace->slug,$task->project_id,$task->id,$clientID])); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                        ...
                        <?php $__currentLoopData = $task->sub_tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subTask): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="list-group-item pt-2 pb-0">
                                <label class="custom-switch pl-0">
                                    <input type="checkbox" name="option" value="<?php echo e($subTask->id); ?>" class="custom-switch-input" <?php if($subTask->status): ?> checked <?php endif; ?> data-url="<?php echo e(route('subtask.update',[$currantWorkspace->slug,$task->project_id,$subTask->id])); ?>">
                                ...
                                <div class="float-right">
                                    <a href="#" class="text-danger text-muted delete-subtask" data-url="<?php echo e(route('subtask.destroy',[$currantWorkspace->slug,$task->project_id,$subTask->id])); ?>">
                                        <i class="dripicons-trash"></i>
                                    </a>
                                </div>
                            </li>
...
<?php endif; ?>
<?php /**PATH /home/bwhitwbh/public_html/projects/resources/views/projects/taskShow.blade.php ENDPATH**/ ?>