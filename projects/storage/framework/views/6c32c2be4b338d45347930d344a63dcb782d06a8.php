...
<?php if($project && $currantWorkspace): ?>
    ...
    <form class="pl-3 pr-3" method="post" action="<?php echo e(route('projects.milestone.store',[$currantWorkspace->slug,$project->id])); ?>">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/Taskly2/site/resources/views/projects/milestone.blade.php ENDPATH**/ ?>