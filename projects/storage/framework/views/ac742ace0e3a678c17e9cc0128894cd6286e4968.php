        ...
        <div class="col-sm-4">
            <?php if(auth()->guard('web')->check()): ?>
                <?php if($currantWorkspace->creater->id == Auth::user()->id): ?>
                    <button type="button" class="btn btn-primary btn-rounded mb-3" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Create New Project')); ?>" data-url="<?php echo e(route('projects.create',$currantWorkspace->slug)); ?>">
            ...
            <div class="card author-box card-primary">
                <div class="card-body">
                    ...
                    <div class="author-box-name">
                        ...
                        <a href="<?php if(auth()->guard('web')->check()): ?><?php echo e(route('projects.show',[$currantWorkspace->slug,$project->id])); ?><?php elseif(auth()->guard()->check()): ?><?php echo e(route('client.projects.show',[$currantWorkspace->slug,$project->id])); ?><?php endif; ?>" title="<?php echo e($project->name); ?>" class="text-title"><?php echo e($project->name); ?></a>
                    ...
                    <div class="float-right mt-sm-0 mt-3">
                        <a href="<?php if(auth()->guard('web')->check()): ?><?php echo e(route('projects.show',[$currantWorkspace->slug,$project->id])); ?><?php elseif(auth()->guard()->check()): ?><?php echo e(route('client.projects.show',[$currantWorkspace->slug,$project->id])); ?><?php endif; ?>" class="btn btn-sm btn-primary"><?php echo e(__('View More')); ?> <i class="dripicons-arrow-right"></i></a>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bwhitwbh/public_html/projects/resources/views/projects/index.blade.php ENDPATH**/ ?>