...
<?php if($project && $currantWorkspace && $task): ?>

    <form class="pl-3 pr-3" method="post" action="<?php if(auth()->guard('web')->check()): ?><?php echo e(route('tasks.update',[$currantWorkspace->slug,$project->id,$task->id])); ?><?php elseif(auth()->guard()->check()): ?><?php echo e(route('client.tasks.update',[$currantWorkspace->slug,$project->id,$task->id])); ?><?php endif; ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control form-control-light" id="assign_to" name="assign_to" required>
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php if($task->assign_to==$u->id): ?> selected <?php endif; ?> value="<?php echo e($u->id); ?>"><?php echo e($u->name); ?> - <?php echo e($u->email); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="<?php echo e($task->due_date); ?>" class="form-control form-control-light date" id="due_date" data-provide="datepicker" data-date-format="yy-mm-dd" name="due_date" required autocomplete="off">
                </div>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH /home/bwhitwbh/public_html/projects/resources/views/projects/taskEdit.blade.php ENDPATH**/ ?>