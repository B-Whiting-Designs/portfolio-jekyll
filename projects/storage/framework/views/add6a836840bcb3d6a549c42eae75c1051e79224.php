...
<?php if($milestone && $currantWorkspace): ?>
    ...
    <form class="pl-3 pr-3" method="post" action="<?php if(auth()->guard('web')->check()): ?><?php echo e(route('projects.milestone.update',[$currantWorkspace->slug,$milestone->id])); ?><?php elseif(auth()->guard()->check()): ?><?php echo e(route('client.projects.milestone.update',[$currantWorkspace->slug,$milestone->id])); ?><?php endif; ?>">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /home/bwhitwbh/public_html/projects/resources/views/projects/milestoneEdit.blade.php ENDPATH**/ ?>