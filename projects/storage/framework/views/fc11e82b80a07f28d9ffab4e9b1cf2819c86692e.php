        ...
        <div class="card-header">
            ...
            <div class="card-header-action">
                <div class="dropdown card-widgets">
                    <a href="<?php echo e(route('client.login')); ?>" class="btn btn-sm btn-secondary"><?php echo e(__('Client Login')); ?></a>
                </div>
            </div>
        </div>
        <div class="card-body">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bwhitwbh/public_html/projects/resources/views/auth/login.blade.php ENDPATH**/ ?>