            ...
            <div class="col-sm-8">
                <div class="text-sm-right">
                    <div class="btn-group mt-4">
                        ...
                        <?php elseif(isset($permisions) && in_array('create task',$permisions)): ?>
                            <a href="#" class="btn btn-primary ml-3" data-ajax-popup="true" data-size="lg"
                               data-title="<?php echo e(__('Create New Task')); ?>"
                               data-url="<?php echo e(route('client.tasks.create',[$currantWorkspace->slug,$project->id])); ?>"><i class="mdi mdi-plus"></i> <?php echo e(__('Add New')); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="card-body p-3">
                                            <div class="dropdown float-right">
                                                ...
                                                <?php elseif(isset($permisions)): ?>
                                                    <?php if(in_array('edit task',$permisions)): ?>
                                                        <a href="#" class="dropdown-item" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Edit Task')); ?>" data-url="<?php echo e(route('client.tasks.edit',[$currantWorkspace->slug,$taskDetail->project_id,$taskDetail->id])); ?>">
                                                            <i class="mdi mdi-pencil mr-1"></i><?php echo e(__('Edit')); ?>

                                                        </a>
                                                    <?php endif; ?>
                                                    <?php if(in_array('delete task',$permisions)): ?>
                                                        <a href="#" class="dropdown-item" onclick="(confirm('Are you sure ?')?document.getElementById('delete-form-<?php echo e($taskDetail->id); ?>').submit(): '');">
                                                            <i class="mdi mdi-delete mr-1"></i><?php echo e(__('Delete')); ?>

                                                        </a>
                                                        <form id="delete-form-<?php echo e($taskDetail->id); ?>" action="<?php echo e(route('client.tasks.destroy',[$currantWorkspace->slug,$taskDetail->project_id,$taskDetail->id])); ?>" method="POST" style="display: none;">
                                                            <?php echo csrf_field(); ?>
                                                            <?php echo method_field('DELETE'); ?>
                                                        </form>
                                                    <?php endif; ?>
                                            ...
                                            <div>
                                                <a href="#" data-ajax-popup="true" data-size="lg" data-title="<?php echo e($taskDetail->title); ?> <?php if($taskDetail->priority=="High"): ?><span class='badge badge-danger ml-2'><?php echo e(__('High')); ?></span><?php elseif($taskDetail->priority=="Medium"): ?><span class='badge badge-info'><?php echo e(__('Medium')); ?></span><?php else: ?><span class='badge badge-success'><?php echo e(__('Low')); ?></span><?php endif; ?>" data-url="<?php if(auth()->guard('web')->check()): ?><?php echo e(route('tasks.show',[$currantWorkspace->slug,$taskDetail->project_id,$taskDetail->id])); ?><?php elseif(auth()->guard()->check()): ?><?php echo e(route('client.tasks.show',[$currantWorkspace->slug,$taskDetail->project_id,$taskDetail->id])); ?><?php endif; ?>"
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        !function (a) {
            ...
            t.prototype.init = function () {
                a('[data-plugin="dragula"]').each(function () {
                    ...
                    r ? dragula(n, {
                        ...
                        $.ajax({
                            url:'<?php if(auth()->guard('web')->check()): ?><?php echo e(route('tasks.update.order',[$currantWorkspace->slug,$project->id])); ?><?php elseif(auth()->guard()->check()): ?><?php echo e(route('client.tasks.update.order',[$currantWorkspace->slug,$project->id])); ?><?php endif; ?>',
                            type:'PUT',
            ...
            "use strict";
            <?php if(auth()->guard('client')->check()): ?>
                <?php if(isset($permisions) && in_array('move task',$permisions)): ?>
                    a.Dragula.init()
                <?php endif; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bwhitwbh/public_html/projects/resources/views/projects/taskboard.blade.php ENDPATH**/ ?>