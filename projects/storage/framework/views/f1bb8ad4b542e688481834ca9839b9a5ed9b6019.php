...
<?php if($project && $currantWorkspace && $bug): ?>

    <form class="pl-3 pr-3" method="post" action="<?php if(auth()->guard('web')->check()): ?><?php echo e(route('projects.bug.report.update',[$currantWorkspace->slug,$project->id,$bug->id])); ?><?php elseif(auth()->guard()->check()): ?><?php echo e(route('client.projects.bug.report.update',[$currantWorkspace->slug,$project->id,$bug->id])); ?><?php endif; ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-light" id="task-title" placeholder="<?php echo e(__('Enter Title')); ?>" name="title" value="<?php echo e($bug->title); ?>" required>
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control form-control-light" id="status" name="status" required>
                        <?php $__currentLoopData = $arrStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php if($bug->status==$status): ?> selected <?php endif; ?> value="<?php echo e($status); ?>"><?php echo e(__(ucfirst($status))); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control form-control-light" id="task-description" rows="3" name="description"><?php echo e($bug->description); ?></textarea>
        </div>
...
<?php endif; ?><?php /**PATH /var/www/html/Taskly2/site/resources/views/projects/bug_report_edit.blade.php ENDPATH**/ ?>